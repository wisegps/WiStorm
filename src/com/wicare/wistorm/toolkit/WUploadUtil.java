 ...
 * Map<String, String> params = new HashMap<String, String>();
   uploadUtil.uploadFile( picPath,"image", requestURL,params);
 */
/**
 * 
 * 上传工具类
 * 支持上传文件和参数
 */
public class WUploadUtil {
	private static WUploadUtil wUploadUtil;
	 ...
	 * @return
	 */
	public static WUploadUtil getInstance() {
		if (null == wUploadUtil) {
			wUploadUtil = new WUploadUtil();
		}
		return wUploadUtil;
	}
