...
//	private RectF boundScaleRing;
	...
	public WCircleProView(Context context) {
		super(context);
	}

	//下面这个构造可以在xml 中引用
	public WCircleProView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//		canvas.drawArc(boundScaleRing, 0, 360 , false, paintScaleRing);//画圆弧
		canvas.restore();
		...
		canvas.drawArc(boundTimeRing ,0f, 359.0f, false, paintProgressRing);//画进度圆环
		canvas.restore();
