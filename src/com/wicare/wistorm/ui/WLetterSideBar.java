...
public class WLetterSideBar extends View {
	...
	public WLetterSideBar(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public WLetterSideBar(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public WLetterSideBar(Context context) {
		super(context);
	}
