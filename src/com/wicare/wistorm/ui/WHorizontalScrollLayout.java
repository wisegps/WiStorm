 ...
 * 
 */
public class WHorizontalScrollLayout extends ViewGroup {
    
    static String TAG = "HScrollLayout";
    ...
    OnViewChangeListener mOnViewChangeListener; //监听接口
    Scroller scroller;
    Context mContext;
    public WHorizontalScrollLayout(Context context) {
        super(context);
        init(context);
    }
    public WHorizontalScrollLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
     ...
     * @param whichScreen
     */
    public void jumpToScreen(int whichScreen) {
